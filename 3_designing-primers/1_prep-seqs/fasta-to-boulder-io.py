...
def generate_primer3_input(input_fasta, output_file):
    # Primer3 parameters
    primer3_params = """PRIMER_TASK=generic
...
PRIMER_INTERNAL_OLIGO_MIN_SIZE=20
PRIMER_INTERNAL_OLIGO_MAX_SIZE=30
PRIMER_PRODUCT_SIZE_RANGE=100-200
PRIMER_INTERNAL_OLIGO_OPT_TM=67.0
PRIMER_INTERNAL_OLIGO_MIN_TM=67.0
PRIMER_INTERNAL_OLIGO_MAX_TM=67.0
PRIMER_OPT_TM=60.0
PRIMER_MIN_TM=60.0
PRIMER_MAX_TM=60.0
